...
module.exports = function (_Renderer) {
  ...
  function VideoRenderer(options) {
    ...
    var _this = _possibleConstructorReturn(this, (VideoRenderer.__proto__ || Object.getPrototypeOf(VideoRenderer)).call(this, options));
  ...
  _createClass(VideoRenderer, [{
    ...
    value: function scheduleSegmentRender(segment, delay) {
      _get(VideoRenderer.prototype.__proto__ || Object.getPrototypeOf(VideoRenderer.prototype), 'scheduleSegmentRender', this).call(this, segment, delay);
