...
module.exports = function (_Renderer) {
  ...
  function WebRenderer(options) {
    ...
    var _this = _possibleConstructorReturn(this, (WebRenderer.__proto__ || Object.getPrototypeOf(WebRenderer)).call(this, options));
  ...
  _createClass(WebRenderer, [{
    ...
    value: function scheduleSegmentRender(segment, delay) {
      _get(WebRenderer.prototype.__proto__ || Object.getPrototypeOf(WebRenderer.prototype), 'scheduleSegmentRender', this).call(this, segment, delay);
