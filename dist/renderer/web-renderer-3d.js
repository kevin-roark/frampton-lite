...
module.exports = function (_WebRenderer) {
  ...
  function WebRenderer3D(options) {
    ...
    var _this = _possibleConstructorReturn(this, (WebRenderer3D.__proto__ || Object.getPrototypeOf(WebRenderer3D)).call(this, options));

    var rendererProvider = options.rendererProvider,
        sceneProvider = options.sceneProvider,
        cameraProvider = options.cameraProvider,
        ambientLightProvider = options.ambientLightProvider;
  ...
  _createClass(WebRenderer3D, [{
    ...
    value: function update() {
      _get(WebRenderer3D.prototype.__proto__ || Object.getPrototypeOf(WebRenderer3D.prototype), 'update', this).call(this);
    ...
    value: function renderVideoSegment(segment, options) {
      if (!segment.threeOptions) {
        _get(WebRenderer3D.prototype.__proto__ || Object.getPrototypeOf(WebRenderer3D.prototype), 'renderVideoSegment', this).call(this, segment, options);
        return;
      }
      ...
      var _segment$threeOptions = segment.threeOptions,
          _segment$threeOptions2 = _segment$threeOptions.videoMeshWidth,
          videoMeshWidth = _segment$threeOptions2 === undefined ? 150 : _segment$threeOptions2,
          _segment$threeOptions3 = _segment$threeOptions.videoSourceWidth,
          videoSourceWidth = _segment$threeOptions3 === undefined ? 854 : _segment$threeOptions3,
          _segment$threeOptions4 = _segment$threeOptions.videoMeshHeight,
          videoMeshHeight = _segment$threeOptions4 === undefined ? 75 : _segment$threeOptions4,
          _segment$threeOptions5 = _segment$threeOptions.videoSourceHeight,
          videoSourceHeight = _segment$threeOptions5 === undefined ? 480 : _segment$threeOptions5,
          meshConfigurer = _segment$threeOptions.meshConfigurer,
          geometryProvider = _segment$threeOptions.geometryProvider;
