...
module.exports = function (_MediaSegment) {
  ...
  function VisualSegment(options) {
    ...
    var _this = _possibleConstructorReturn(this, (VisualSegment.__proto__ || Object.getPrototypeOf(VisualSegment)).call(this, options));
  ...
  _createClass(VisualSegment, [{
    ...
    value: function copy(visualSegment) {
      _get(VisualSegment.prototype.__proto__ || Object.getPrototypeOf(VisualSegment.prototype), 'copy', this).call(this, visualSegment);
