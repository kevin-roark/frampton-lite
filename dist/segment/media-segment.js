...
module.exports = function (_Segment) {
  ...
  function MediaSegment(options) {
    ...
    var _this = _possibleConstructorReturn(this, (MediaSegment.__proto__ || Object.getPrototypeOf(MediaSegment)).call(this, options));
  ...
  _createClass(MediaSegment, [{
    ...
    value: function copy(mediaSegment) {
      _get(MediaSegment.prototype.__proto__ || Object.getPrototypeOf(MediaSegment.prototype), 'copy', this).call(this, mediaSegment);
