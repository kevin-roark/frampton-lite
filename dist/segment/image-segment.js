...
module.exports = function (_Segment) {
  ...
  function ImageSegment(options) {
    ...
    var _this = _possibleConstructorReturn(this, (ImageSegment.__proto__ || Object.getPrototypeOf(ImageSegment)).call(this, options));
  ...
  _createClass(ImageSegment, [{
    ...
    value: function copy(imageSegment) {
      _get(ImageSegment.prototype.__proto__ || Object.getPrototypeOf(ImageSegment.prototype), 'copy', this).call(this, imageSegment);
