...
module.exports = function (_MediaSegment) {
  ...
  function AudioSegment(options) {
    ...
    var _this = _possibleConstructorReturn(this, (AudioSegment.__proto__ || Object.getPrototypeOf(AudioSegment)).call(this, options));
  ...
  _createClass(AudioSegment, [{
    ...
    value: function copy(audioSegment) {
      _get(AudioSegment.prototype.__proto__ || Object.getPrototypeOf(AudioSegment.prototype), 'copy', this).call(this, audioSegment);
