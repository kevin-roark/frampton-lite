...
module.exports = function (_Segment) {
  ...
  function SequencedSegment() {
    ...
    var _this = _possibleConstructorReturn(this, (SequencedSegment.__proto__ || Object.getPrototypeOf(SequencedSegment)).call(this, options));
  ...
  _createClass(SequencedSegment, [{
    ...
    value: function copy(sequencedSegment, recursive) {
      _get(SequencedSegment.prototype.__proto__ || Object.getPrototypeOf(SequencedSegment.prototype), 'copy', this).call(this, sequencedSegment);
