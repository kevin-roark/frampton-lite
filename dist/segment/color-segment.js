...
module.exports = function (_VisualSegment) {
  ...
  function ColorSegment(options) {
    ...
    var _this = _possibleConstructorReturn(this, (ColorSegment.__proto__ || Object.getPrototypeOf(ColorSegment)).call(this, options));
  ...
  _createClass(ColorSegment, [{
    ...
    value: function copy(colorSegment) {
      _get(ColorSegment.prototype.__proto__ || Object.getPrototypeOf(ColorSegment.prototype), 'copy', this).call(this, colorSegment);
