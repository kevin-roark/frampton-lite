...
module.exports = function (_Segment) {
  ...
  function TextSegment(options) {
    ...
    var _this = _possibleConstructorReturn(this, (TextSegment.__proto__ || Object.getPrototypeOf(TextSegment)).call(this, options));
  ...
  _createClass(TextSegment, [{
    ...
    value: function copy(textSegment) {
      _get(TextSegment.prototype.__proto__ || Object.getPrototypeOf(TextSegment.prototype), 'copy', this).call(this, textSegment);
