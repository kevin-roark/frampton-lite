...
module.exports = function (_Segment) {
  ...
  function StackedSegment() {
    ...
    var _this = _possibleConstructorReturn(this, (StackedSegment.__proto__ || Object.getPrototypeOf(StackedSegment)).call(this, options));
  ...
  _createClass(StackedSegment, [{
    ...
    value: function copy(stackedSegment, recursive) {
      _get(StackedSegment.prototype.__proto__ || Object.getPrototypeOf(StackedSegment.prototype), 'copy', this).call(this, stackedSegment);
