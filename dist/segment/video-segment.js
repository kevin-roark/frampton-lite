...
module.exports = function (_VisualSegment) {
  ...
  function VideoSegment(options) {
    ...
    var _this = _possibleConstructorReturn(this, (VideoSegment.__proto__ || Object.getPrototypeOf(VideoSegment)).call(this, options));
  ...
  _createClass(VideoSegment, [{
    ...
    value: function copy(videoSegment) {
      _get(VideoSegment.prototype.__proto__ || Object.getPrototypeOf(VideoSegment.prototype), 'copy', this).call(this, videoSegment);
